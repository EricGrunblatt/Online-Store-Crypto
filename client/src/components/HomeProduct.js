...
export default function HomeProduct(props) {
    ...
    return (
        <div className="home-product">
            ...
            <div onClick={() => {history.push("/product")}} className="home-product-information" style={{ cursor: 'pointer', margin: '0px 0px 0px 20px', width: width, minHeight: nameHeight, maxHeight: height, color: 'rgba(0, 0, 0, 0.9)', background: 'rgba(0, 0, 0, 0.2)', border: 'grey 1px solid', borderRadius: '10px', boxShadow: '0px 2px 5px 2px rgba(0, 0, 0, 0.2)' }}>
