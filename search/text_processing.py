...
def getTrigram(df_all):
    ...
    df_all['product_title_cut']= df_all['product_title'].map(lambda x: cut_product_title(x))
    ...
    df_all['product_title_cut_tokens'] =col_tagger(df_all['product_title_cut'])
    df_all['product_title_cut_wordtokens'] =col_wordtagger(df_all['product_title_cut'])
    ...
    # df_all['search_term_cut']= df_all['search_term'].map(lambda x: cut_product_title(x).encode('utf-8'))
    df_all['search_term_cut']= df_all['search_term'].map(lambda x: cut_product_title(x))
    df_all['search_term_cut_tokens'] =col_tagger(df_all['search_term_cut'])
    df_all['search_term_cut_wordtokens'] =col_wordtagger(df_all['search_term_cut'])
    ...
    # print(df_all['product_title_keys'].to_string(index=False))
    ...
    # print(df_all['product_title_thekey'].to_string(index=False))
